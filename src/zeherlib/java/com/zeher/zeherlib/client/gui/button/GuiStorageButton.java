package com.zeher.zeherlib.client.gui.button;
...
public class GuiStorageButton extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float ticks) {
		if (this.visible) {
			...
			mc.getTextureManager().bindTexture(Reference.GUI.RESOURCE.STORAGE_BUTTON_TEXTURES);
			...
			if (this.identifier <= 5) {
				if (this.width == 20 && this.height == 20) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X[identifier], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y[i], this.width, this.height);
				} else if (this.width == 18 && this.height == 18) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X_SMALL[identifier], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y_SMALL[i], this.width, this.height);
				}
			} else if (this.identifier > 5 && this.identifier <= 11) {
				if (this.width == 20 && this.height == 20) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X[identifier - 6], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y[i + 3], this.width, this.height);
				} else if (this.width == 18 && this.height == 18) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X_SMALL[identifier - 6], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y_SMALL[i + 3], this.width, this.height);
				}
			} else if (this.identifier > 11 && this.identifier <= 17) {
				if (this.width == 20 && this.height == 20) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X[identifier - 12], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y[i + 6], this.width, this.height);
				} else if (this.width == 18 && this.height == 18) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X_SMALL[identifier - 12], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y_SMALL[i + 6], this.width, this.height);
				}
			}  else if (this.identifier > 17 && this.identifier <= 23) {
				if (this.width == 20 && this.height == 20) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X[identifier - 18], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y[i + 9], this.width, this.height);
				} else if (this.width == 18 && this.height == 18) {
					this.drawTexturedModalRect(this.xPosition, this.yPosition, Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_X_SMALL[identifier - 18], Reference.GUI.GUI_BUTTON_INFO.BUTTON_STATE_Y_SMALL[i + 9], this.width, this.height);
				}
			}
