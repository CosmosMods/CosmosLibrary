...
public class BlockConnected extends ModBlock {
	...
	public BlockConnected(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
