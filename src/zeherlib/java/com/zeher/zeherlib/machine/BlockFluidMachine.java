...
public class BlockFluidMachine extends ModBlockContainer {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public int power;

	public BlockFluidMachine(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
