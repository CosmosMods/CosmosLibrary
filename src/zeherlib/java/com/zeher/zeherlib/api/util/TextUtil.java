package com.zeher.zeherlib.api.util;
...
public final class TextUtil {
	...
	public static String shiftForDetails() {
		...
		return LIGHT_GRAY + localize(Reference.TOOLTIP.HOLD) + " " + ORANGE + BOLD + localize(Reference.TOOLTIP.SHIFT) + " " + END + LIGHT_GRAY + localize(Reference.TOOLTIP.FOR_DETAILS) + END;
	}
