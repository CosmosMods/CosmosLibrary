...
public class CosmosElytraArmourLayer<T extends LivingEntity, M extends BipedModel<T>, A extends BipedModel<T>> extends LayerRenderer<T, M> {
	private static final Map<String, ResourceLocation> ARMOR_LOCATION_CACHE = Maps.newHashMap();
	private final A innerModel;
	private final A outerModel;

	public CosmosElytraArmourLayer(IEntityRenderer<T, M> p_i50936_1_, A p_i50936_2_, A p_i50936_3_) {
		super(p_i50936_1_);
	...
	private void renderArmorPiece(MatrixStack p_241739_1_, IRenderTypeBuffer p_241739_2_, T p_241739_3_, EquipmentSlotType p_241739_4_, int p_241739_5_, A p_241739_6_) {
		...
		if (itemstack.getItem() instanceof CosmosElytraArmourItem) {
			CosmosElytraArmourItem armoritem = (CosmosElytraArmourItem) itemstack.getItem();
	...
	private void renderModel(MatrixStack p_241738_1_, IRenderTypeBuffer p_241738_2_, int p_241738_3_, CosmosElytraArmourItem p_241738_4_, boolean p_241738_5_, A p_241738_6_, boolean p_241738_7_, float p_241738_8_, float p_241738_9_, float p_241738_10_, @Nullable String p_241738_11_) {
	...
	private ResourceLocation getArmorLocation(CosmosElytraArmourItem p_241737_1_, boolean p_241737_2_, @Nullable String p_241737_3_) {
	...
	public ResourceLocation getArmorResource(net.minecraft.entity.Entity entity, ItemStack stack, EquipmentSlotType slot, @Nullable String type) {
		CosmosElytraArmourItem item = (CosmosElytraArmourItem) stack.getItem();
