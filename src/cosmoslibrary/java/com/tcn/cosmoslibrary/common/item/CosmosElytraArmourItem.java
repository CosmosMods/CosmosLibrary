...
public class CosmosElytraArmourItem extends ArmorItem implements IArmorVanishable {
	
	private Item repairItem;
	private static boolean damageable;

	public CosmosElytraArmourItem(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn, Item itemIn, boolean damageableIn) {
	...
	public boolean isValidRepairItem(ItemStack stackIn, ItemStack repairStackIn) {
		return repairStackIn.getItem().equals(repairItem);
	}
