...
public final class CosmosCompHelper {
	...
	public static IFormattableTextComponent shiftForMoreDetails() {
		return locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_HOLD).append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.ORANGE, true, BASE.TOOLTIP_SHIFT)
				.append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_FOR_DETAILS)));
	...
	public static IFormattableTextComponent shiftForLessDetails() {
		return locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_RELEASE).append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.ORANGE, true, BASE.TOOLTIP_SHIFT)
				.append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_LESS_DETAILS)));
	}
	
	public static IFormattableTextComponent ctrlForMoreDetails() {
		return locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_HOLD).append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.PURPLE, true, BASE.TOOLTIP_CTRL)
	...
	public static IFormattableTextComponent ctrlForLessDetails() {
		return locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_RELEASE).append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.PURPLE, true, BASE.TOOLTIP_CTRL)
				.append(locComp(CosmosColour.BLACK, false, " ")).append(locComp(CosmosColour.WHITE, false, BASE.TOOLTIP_NBT_LESS_DETAILS)));
	}
