...
public enum EnumSideState implements IStringSerializable {
	...
	public static final EnumSideState[] STANDARD = new EnumSideState[] { INTERFACE_NORMAL, INTERFACE_NORMAL, INTERFACE_NORMAL, INTERFACE_NORMAL, INTERFACE_NORMAL, INTERFACE_NORMAL };
