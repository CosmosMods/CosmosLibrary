...
public enum EnumLockState {
	...
	UNLOCKED(0, "unlocked", "cosmoslibrary.enum.lock_state.unlocked", false, CosmosColour.GREEN),
	LOCKED(1, "locked", "cosmoslibrary.enum.lock_state.locked", true, CosmosColour.RED),
