...
public class CosmosButtonWithType extends Button {
	...
	public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
		if (this.buttonType != null) {
			CosmosUISystem.setTextureWithColourAlpha(poseStack, this.buttonType.getButtonTexture(false), new float[] { 1.0F, 1.0F, 1.0F, 1.0F });
			...
			if (this.identifier >= 0 && this.identifier <= 23) {
				if (this.identifier >= 0 && this.identifier <= 5) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier], INFO.BUTTON_STATE_Y[i], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier], INFO.BUTTON_STATE_Y_SMALL[i], this.width, this.height);
					}
				} else if (this.identifier > 5 && this.identifier <= 11) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 6], INFO.BUTTON_STATE_Y[i + 3], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 6], INFO.BUTTON_STATE_Y_SMALL[i + 3], this.width, this.height);
					}
				} else if (this.identifier > 11 && this.identifier <= 17) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 12], INFO.BUTTON_STATE_Y[i + 6], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 12], INFO.BUTTON_STATE_Y_SMALL[i + 6], this.width, this.height);
					}
				} else if (this.identifier > 17 && this.identifier <= 23) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 18], INFO.BUTTON_STATE_Y[i + 9], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 18], INFO.BUTTON_STATE_Y_SMALL[i + 9], this.width, this.height);
					}
				} 
			}
				...
				if (this.identifier > 23 && this.identifier <= 29) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 24], INFO.BUTTON_STATE_Y[i], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 24], INFO.BUTTON_STATE_Y_SMALL[i], this.width, this.height);
					}
				} else if (this.identifier > 29 && this.identifier <= 35) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 30], INFO.BUTTON_STATE_Y[i + 3], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 30], INFO.BUTTON_STATE_Y_SMALL[i + 3], this.width, this.height);
					}
				} else if (this.identifier > 35 && this.identifier <= 41) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 36], INFO.BUTTON_STATE_Y[i + 6], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 36], INFO.BUTTON_STATE_Y_SMALL[i + 6], this.width, this.height);
					}
				} else if (this.identifier > 41 && this.identifier <= 47) {
					if (this.width == 20 && this.height == 20) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X[identifier - 42], INFO.BUTTON_STATE_Y[i + 9], this.width, this.height);
					} else if (this.width == 18 && this.height == 18) {
						this.blit(poseStack, this.x, this.y, INFO.BUTTON_STATE_X_SMALL[identifier - 42], INFO.BUTTON_STATE_Y_SMALL[i + 9], this.width, this.height);
					}
				}
			}
		}
