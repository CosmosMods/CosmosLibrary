...
private final BiFunction<Options, CosmosOptionPercentageSlider, Component> toString;
   ...
   public CosmosOptionPercentageSlider(ComponentColour colour, boolean bold, String caption, double minValueIn, double maxValueIn, float stepSizeIn, Function<Options, Double> getter, BiConsumer<Options, Double> setter, BiFunction<Options, CosmosOptionPercentageSlider, Component> getDisplayString) {
      super(caption);
