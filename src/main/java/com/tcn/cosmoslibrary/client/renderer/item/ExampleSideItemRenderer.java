...
@OnlyIn(Dist.CLIENT)
public class ExampleSideItemRenderer extends TileEntityRenderer<TileEntity> {

	public ExampleSideItemRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
