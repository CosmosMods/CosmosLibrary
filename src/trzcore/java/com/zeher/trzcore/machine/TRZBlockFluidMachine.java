...
public class TRZBlockFluidMachine extends TRZBlockContainer {
	
	public int power;

	public TRZBlockFluidMachine(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
